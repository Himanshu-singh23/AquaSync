    ...
    <div class="py-12 bg-gradient-to-br from-blue-50 to-indigo-50 min-h-screen">
        <div class="max-w-xl mx-auto sm:px-6 lg:px-8">
            <div class="bg-white overflow-hidden shadow-2xl rounded-3xl border border-blue-100 p-8">
                ...
                @if(isset($currentGoal) && $currentGoal->target_liters_per_month > 0 && isset($totalUsage) && $totalUsage > $currentGoal->target_liters_per_month)
                <div class="bg-orange-100 border-l-4 border-orange-500 text-orange-700 p-4 mb-6 rounded shadow-sm" role="alert">
                    <p class="font-bold flex items-center">
                        ...
                        Warning: Monthly Goal Exceeded
                    </p>
                    <p class="mt-1 text-sm">Your total water usage ({{ $totalUsage }}L) has exceeded your goal of {{ $currentGoal->target_liters_per_month }}L. Please consider adjusting your goal on the dashboard.</p>
                </div>
                @endif
